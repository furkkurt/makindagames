  ...
  <body>
    <header class="flex items-center justify-between bg-tpGrey h-16">
      ...
      <div class="justify-around space-x-4 pr-8 whitespace-nowrap">
        <a href="index.html" class="text-tpPink font-custom1 hover:text-tpRed hover:scale-110 transition">Games</a>
        <a href="about.html" class="text-tpPink font-custom1 hover:text-tpRed hover:scale-110 transition">About</a>
        <a href="portfolio.html" class="text-tpPink font-custom1 hover:text-tpRed hover:scale-110 transition">Portfolio</a>
        <a href="blog.html" class="text-tpPink font-custom1 hover:text-tpRed hover:scale-110 transition">Blog</a>
      </div>
